<footer id="sticky-footer" class="flex-shrink-0 py-4 bg-dark fontModal">
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-white d-flex justify-content-center"><h2>PRESTO.IT</h2></div>
    </div>
  </div>
  <div class="container d-flex justify-content-center">
    <div class="row">
      <div class="col-3 text-white "><a href=""><img class="socialicons" src="\social\facebook.png" alt="facebook icon"></a></div>
      <div class="col-3 text-white "><a href=""><img class="socialicons" src="\social\instagram.png" alt="instagram icon"></a></div>
      <div class="col-3 text-white "><a href=""><img class="socialicons" src="\social\linkedin.png" alt="linkedin icon"></a></div>
      <div class="col-3 text-white "><a href=""><img class="socialicons" src="\social\twitter.png" alt="twitter icon"></a></div>
    </div>
  </div>
  ...
  <div class="text-white d-flex justify-content-center fs-5">
    <p>© 2023 PRESTO.IT. Tutti i diritti riservati • P.IVA IT07647333333 </p>
  </div>   
</footer>
